...
def create_yearly_data(
    ...
    input_folder = f"/work/pd1309/CCLM-CRCS/observationalData/HYRAS/v6-0/{variable}"

    if not os.path.exists(output_folder):
        os.mkdir(output_folder)

    output_filename = os.path.join(output_folder, "Hyras.nc")
...
def precompute_masks(country):
    resolutions = {
        "HYRAS": "/work/pd1309/CCLM-CRCS/observationalData/HYRAS/v6-0/rsds/rsds_hyras_5_1994_v3-1.nc"
    }
