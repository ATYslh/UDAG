...
def find_folders(variable) -> list[str]:
    ...
    base = "/work/bb1364/production_runs/work/IES585L01/post/yearly"
    variable_old=''
...
def generate_filename(variable: str) -> str:
    return f"EUR-12_CLMcom-Hereon_EC-Earth3-Veg_ssp585_{variable}.nc"
...
def precompute_masks(country):
    resolutions = {
        "EUR-12": "/work/bb1364/production_runs/work/IRS585L01/post/yearly/TOT_PREC/TOT_PREC_2015010100-2016010100.ncz",
    }
